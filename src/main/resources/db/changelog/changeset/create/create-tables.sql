...
(
    ...
    constraint FK_team_sport_type foreign key (sport_type_id) references sport_type on delete cascade,
...
(
    ...
    constraint FK_athlete_team foreign key (team_id) references team on delete cascade,
